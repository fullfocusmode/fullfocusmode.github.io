...
const TaskManager = { 
    init: function() { 
        ...
        this.renderCalendar(); 
        this.renderNotes(); // Render notes on initialization 
    }, 
    ...
    exportData: function() { 
        const data = { 
            ...
            notes: this.notes // Include notes in the export 
        }; 
    ...
    clearAllData: function() { 
        if (confirm('Are you sure you want to clear all data? This action cannot be undone.')) { 
            ...
            localStorage.removeItem('fullfocus_notes'); // Remove notes from local storage 
            ...
            this.applySettings(); 
            this.renderCalendar(); 
            this.renderNotes(); // Render notes after clearing data 
        } 
    },
    loadNotes: function() { 
...
function setupTaskListeners() { 
    ...
    if (newTaskForm) { 
        newTaskForm.addEventListener('submit', function(e) { 
            ...
            TaskManager.addTask({ title, description, type, date, priority }); 
            closeCurrentModal(); 
        }); 
    } 
    ...
    if (searchButton && searchInput) { 
        searchButton.addEventListener('click', function() { 
            TaskManager.searchTasks(searchInput.value); 
        }); 
    ...
    if (editTaskButton) { 
        editTaskButton.addEventListener('click', function() { 
            const taskId = this.dataset.id; 
            // Implement your edit task logic here...  This needs to be added. 
        }); 
    } 
